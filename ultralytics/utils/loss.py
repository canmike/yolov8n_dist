...
class v8DetectionLoss:
    ...
    def bbox_decode(self, anchor_points, pred_dist):
        ...
        if self.use_dfl:
            ...
            pred_dist = pred_dist.view(b, a, 4, c // 4).softmax(3).matmul(self.proj.to(self.device).type(pred_dist.dtype))
    ...
    def __call__(self, preds, batch):
        ...
        return loss * batch_size, loss.detach()  # loss(box, cls, dfl, distance)
